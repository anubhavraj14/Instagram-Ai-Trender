  ...
  "carousels": [
    {
      ...
      "slides": [
        {
          ...
          "body": "MAX 1 short HINGLISH line (or empty). Text is minimal — the photo carries the slide.",
      ...
      "music": "A fitting trending audio for this carousel: song/audio name + a few words on its vibe (e.g. 'Husn - Anuv Jain: soft emotional vibe, good for saves-driven posts')",
...
RULES:
- Each carousel = 6 to 8 slides. Slide 1 = COVER (hook). Middle = "point" slides (one idea each).
  Last = "cta" (follow/save/share ask).
- VISUAL-FIRST: each slide is a full-bleed REAL PHOTO with a tiny text overlay. So every slide
  needs a strong "imageQuery" — concrete, photographable keywords to find a real stock photo
  that fits the slide's idea. Vary the subjects across slides so the carousel feels designed,
  not repetitive. The COVER imageQuery must be the most eye-catching/relevant.
- Headings SHORT and punchy (max ~6 words) — they overlay on the photo. Body = max 1 short line
  or empty. The PHOTO tells the story, not the text.
...
- Make each carousel genuinely useful and specific (real tips, not vague fluff).
- Ready-to-paste HINGLISH caption + 8-12 hashtags per carousel. The caption MUST end
  with a comment-bait CTA that offers a lead magnet, e.g. 'Follow + comment "PDF" and
  I'll send you the detailed guide' — pick a natural 1-2 word keyword per carousel.
- Suggest 1 fitting music/audio track per carousel in "music" — a real, well-known or
  trending song/audio name + its vibe, matched to the carousel's mood.
